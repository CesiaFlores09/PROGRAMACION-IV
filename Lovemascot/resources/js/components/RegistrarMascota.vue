        ...
        <div class="card-body">
            <form v-if="step == '1'" @submit.prevent="siguiente">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="raza" v-model="registro.raza" type="text" class="form-control" name="raza" value="" required autocomplete="raza" autofocus>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            siguiente() {
                this.registro.sexo = this.sexos[0].nombre;
                if (this.registro.id) {
