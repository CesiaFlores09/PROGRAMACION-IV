    ...
    methods:{
        ...
        eliminarCategoria(categoria){
            if( confirm(`Esta seguro de eliminar el categoria ${categoria.nombre}?`) ){
                ...
                query.onsuccess = e=>{
                  this.nuevoCategoria();
                  this.obtenerDatos();
                  this.categoria.msg ='Categoria eliminada con exito';

                };
                query.onerror=e=>{
                  this.categoria.msg=`Error al eliminar la categoria ${e.target.error}`;
              };
            }
            this.nuevoCategoria();
        },
        ...
        guardarCategoria(){
            ...
            let query = store.put(this.categoria);
             ...
             this.nuevoCategoria();
             this.obtenerDatos();
             this.categoria.msg = 'Categoria procesada con exito';
        ...
        obtenerDatos(valor=''){
           ...
           data.onerror = e=>{
               this.categorias.msg =`Error al obtener las categorias ${e.target.error}`;
           };
        },
        nuevoCategoria(){
